...
ALTER TABLE CHARACTERS ADD CHAR_CUR_HP INT NOT NULL DEFAULT 100;
ALTER TABLE CHARACTERS ADD CHAR_CUR_MP INT NOT NULL DEFAULT 10;
ALTER TABLE CHARACTERS ADD CHAR_CUR_EXP INT NOT NULL DEFAULT 0;
ALTER TABLE CHARACTERS MODIFY CHAR_EXP INT NOT NULL DEFAULT 10;

UPDATE CHARACTERS SET CHAR_CUR_HP=70 WHERE CHAR_NAME='fews';
